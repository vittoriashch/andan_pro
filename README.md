...
<details>
  ...
  Здесь содержится информация, которая будет скрыта по умолчанию, но станет видимой при нажатии на заголовок.
  
  ## Подзаголовок
  
  Можно добавлять любые элементы markdown, такие как списки, изображения и т.д.
