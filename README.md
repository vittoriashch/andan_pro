...
В рамках проекта я (Виктория Щудро) сделала парсинг данных + полный цикл обработки и анализа данных, а также выдвигала гипотезы. Часть с машинным обучением мы делали коллективно:)
