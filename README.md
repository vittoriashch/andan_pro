...
Используя данные по датасету с фильмами (так как в них нет пропусков), мы построили линейную и лассо регрессии. В линейной регресси оказались относительно низкие MAE и MSE, но и низкий R^2$, что говорило о слабости модели.
